...
void copyAttrib(string name, vector<Character *> &characters, vector<Character *> &battle, int num)
{
    int count = num;
    for (int k = 0; k < characters.size(); k++)
    {
        if (name == characters.at(k)->getName())
        {
            if (characters.at(k)->getType() == "knight")
            {
                ...
                newKnight->setClaymore(300 * pow(1 + 0.1, characters.at(k)->getLevel() - 1));
            ...
            else if (characters.at(k)->getType() == "wizard")
            {
                ...
                newWizard->setSpell(150 * pow(1 + 0.1, characters.at(k)->getLevel() - 1));
            ...
            else if (characters.at(k)->getType() == "thief")
            {
                ...
                newThief->setLootbag(100 * pow(1 + 0.1, characters.at(k)->getLevel() - 1));
...
int main()
{
    ...
    while (input != "0")
    {
        if (input == "1")
        {
            cout << "Enter name for new character" << endl
                 << endl;
            string name;
            cin >> name;
        ...
        else if (input == "5")
        {
            ...
            while (gameOver == false)
            {
                ...
                cout << endl
                     << battle.at(0)->getName() << "'s Turn" << endl;
            ...
            for (int q = 0; q < characters.size(); q++)
            {
                if (winner->getName() == characters.at(q)->getName())
                {
                    ...
                    cout << winner->getName() << "'s level: " << characters.at(q)->getLevel() << endl;
